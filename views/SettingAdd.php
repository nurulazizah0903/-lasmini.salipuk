...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fsettingadd = new ew.Form("fsettingadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fsettingadd;
    ...
    fsettingadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fsettingadd" id="fsettingadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
