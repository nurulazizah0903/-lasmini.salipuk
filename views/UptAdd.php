...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fuptadd = new ew.Form("fuptadd", "add");
    ...
    // Form_CustomValidate
    fuptadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fuptadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fuptadd" id="fuptadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
