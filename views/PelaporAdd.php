...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpelaporadd = new ew.Form("fpelaporadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpelaporadd;

    // Add fields
    var fields = currentTable.fields;
    fpelaporadd.addFields([
    ...
    // Form_CustomValidate
    fpelaporadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpelaporadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fpelaporadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fpelaporadd" id="fpelaporadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
