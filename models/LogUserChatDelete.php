 ...
 * Page class
 */
class LogUserChatDelete extends LogUserChat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LogUserChatDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LogUserChatList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LogUserChatList"); // Return to list
                return;
            }
        }
