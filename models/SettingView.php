 ...
 * Page class
 */
class SettingView extends Setting
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SettingView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "SettingList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "SettingList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "SettingList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
