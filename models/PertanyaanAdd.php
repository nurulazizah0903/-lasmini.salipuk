 ...
 * Page class
 */
class PertanyaanAdd extends Pertanyaan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PertanyaanAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("PertanyaanList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "PertanyaanList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PertanyaanView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($curVal != "") {
                ...
                $this->pid->ViewValue = $this->pid->Lookup !== null && is_array($this->pid->lookupOptions()) ? $curVal : null;
            }
            if ($this->pid->ViewValue !== null) { // Load from cache
                $this->pid->EditValue = array_values($this->pid->lookupOptions());
            ...
            // jawaban
            $this->jawaban->setupEditAttributes();
    ...
    protected function addRow($rsold = null)
    {
        ...
        // jawaban
        $this->jawaban->setDbValueDef($rsnew, $this->jawaban->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PertanyaanList"), "", $this->TableVar, true);
