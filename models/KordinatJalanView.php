 ...
 * Page class
 */
class KordinatJalanView extends KordinatJalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KordinatJalanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "KordinatJalanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "KordinatJalanList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "KordinatJalanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
