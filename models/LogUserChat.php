...
/**
 * Table class for log_user_chat
 */
class LogUserChat extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'log_user_chat';
        $this->TableName = 'log_user_chat';
        ...
        $this->pesan->Lookup = new Lookup('pesan', 'pertanyaan', false, 'code', ["code","nama","",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`code`, ''),'" . ValueSeparator(1, $this->pesan) . "',COALESCE(`nama`,''))");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LogUserChatList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "LogUserChatEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "LogUserChatAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LogUserChatView";
            case Config("API_ADD_ACTION"):
                return "LogUserChatAdd";
            case Config("API_EDIT_ACTION"):
                return "LogUserChatEdit";
            case Config("API_DELETE_ACTION"):
                return "LogUserChatDelete";
            case Config("API_LIST_ACTION"):
                return "LogUserChatList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("LogUserChatView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("LogUserChatView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "LogUserChatAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "LogUserChatAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("LogUserChatEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LogUserChatAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("LogUserChatDelete", $this->getUrlParm());
    }
