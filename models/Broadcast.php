...
class Broadcast extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->start_date = new DbField(
            ...
            'start_date',
            '`start_date`',
            CastDateFieldForLike("`start_date`", 9, "DB"),
            135,
            19,
            9,
            false,
        ...
        $this->start_date->DefaultErrorMessage = str_replace("%s", DateFormat(9), $Language->phrase("IncorrectDate"));
        $this->Fields['start_date'] = &$this->start_date;

        // text
        $this->text = new DbField(
            'broadcast',
            'broadcast',
            'x_text',
            'text',
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "broadcast_tujuan") {
            $detailUrl = Container("broadcast_tujuan")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "BroadcastList";
        }
        return $detailUrl;
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "BroadcastEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BroadcastAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BroadcastView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BroadcastView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BroadcastAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BroadcastAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BroadcastEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BroadcastEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BroadcastAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BroadcastAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BroadcastDelete", $this->getUrlParm());
    }
