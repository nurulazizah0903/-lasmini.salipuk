 ...
 * Page class
 */
class PelaporView extends Pelapor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PelaporView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PelaporList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PelaporList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PelaporList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PelaporList"), "", $this->TableVar, true);
        $pageId = "view";
