 ...
 * Page class
 */
class KordinatJalanAdd extends KordinatJalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KordinatJalanAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("KordinatJalanList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "KordinatJalanList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "KordinatJalanView") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->jalan_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->jalan_id->setFormValue($val, true, $validate);
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->jalan_id->EditValue = HtmlEncode($this->jalan_id->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->jalan_id->FormValue)) {
            $this->jalan_id->addErrorMessage($this->jalan_id->getErrorMessage(false));
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // jalan_id
        $this->jalan_id->setDbValueDef($rsnew, $this->jalan_id->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("KordinatJalanList"), "", $this->TableVar, true);
