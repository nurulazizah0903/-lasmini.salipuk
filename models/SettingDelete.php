 ...
 * Page class
 */
class SettingDelete extends Setting
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SettingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SettingList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SettingList"); // Return to list
                return;
            }
        }
