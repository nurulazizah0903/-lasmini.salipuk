 ...
 * Page class
 */
class PertanyaanView extends Pertanyaan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PertanyaanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PertanyaanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PertanyaanList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PertanyaanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
