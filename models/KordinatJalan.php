...
/**
 * Table class for kordinat_jalan
 */
class KordinatJalan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'kordinat_jalan';
        $this->TableName = 'kordinat_jalan';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`kordinat_jalan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`kordinat_jalan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("KordinatJalanList");
    }
    ...
    {
        global $Language;
        if ($pageName == "KordinatJalanView") {
            return $Language->phrase("View");
        } elseif ($pageName == "KordinatJalanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "KordinatJalanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "KordinatJalanView";
            case Config("API_ADD_ACTION"):
                return "KordinatJalanAdd";
            case Config("API_EDIT_ACTION"):
                return "KordinatJalanEdit";
            case Config("API_DELETE_ACTION"):
                return "KordinatJalanDelete";
            case Config("API_LIST_ACTION"):
                return "KordinatJalanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("KordinatJalanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("KordinatJalanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "KordinatJalanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "KordinatJalanAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("KordinatJalanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("KordinatJalanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("KordinatJalanDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->jalan_id->EditValue = $this->jalan_id->CurrentValue;
        $this->jalan_id->PlaceHolder = RemoveHtml($this->jalan_id->caption());
        if (strval($this->jalan_id->EditValue) != "" && is_numeric($this->jalan_id->EditValue)) {
            $this->jalan_id->EditValue = FormatNumber($this->jalan_id->EditValue, null);
        }
        ...
        if (!$this->long->Raw) {
            $this->long->CurrentValue = HtmlDecode($this->long->CurrentValue);
        }
