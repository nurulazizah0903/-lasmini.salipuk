 ...
 * Page class
 */
class LogUserChatView extends LogUserChat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LogUserChatView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LogUserChatList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "LogUserChatList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "LogUserChatList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
