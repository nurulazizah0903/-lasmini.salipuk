...
/**
 * Table class for Report Log User Chat
 */
class ReportLogUserChat extends ReportTable
{
    protected $SqlFrom = "";
    ...
    // Export
    public $ExportDoc;
    public $ChartCatatanPesanPelapor;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'ReportLogUserChat';
        $this->TableName = 'Report Log User Chat';
        ...
        $this->id->Lookup = new Lookup('id', 'ReportLogUserChat', true, 'id', ["id","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->tanggal = new ReportField(
            ...
            'tanggal',
            '`tanggal`',
            CastDateFieldForLike("`tanggal`", 7, "DB"),
            135,
            19,
            7,
            false,
        ...
        $this->tanggal->Lookup = new Lookup('tanggal', 'ReportLogUserChat', true, 'tanggal', ["tanggal","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->code->Lookup = new Lookup('code', 'ReportLogUserChat', true, 'code', ["code","","",""], [], [], [], [], [], [], '', '', "");
        $this->code->SourceTableVar = 'log_user_chat';
        $this->Fields['code'] = &$this->code;

        // Chart Catatan Pesan Pelapor
        $this->ChartCatatanPesanPelapor = new DbChart($this, 'ChartCatatanPesanPelapor', 'Chart Catatan Pesan Pelapor', 'tanggal', 'pelapor_id', 1001, '', 0, 'COUNT', 600, 500);
        $this->ChartCatatanPesanPelapor->YAxisFormat = ["Number"];
        $this->ChartCatatanPesanPelapor->YFieldFormat = ["Number"];
        $this->ChartCatatanPesanPelapor->SortType = 4;
        $this->ChartCatatanPesanPelapor->SortSequence = "";
        $this->ChartCatatanPesanPelapor->SqlSelect = $this->getQueryBuilder()->select("`tanggal`", "''", "COUNT(`pelapor_id`)");
        $this->ChartCatatanPesanPelapor->SqlGroupBy = "`tanggal`";
        $this->ChartCatatanPesanPelapor->SqlOrderBy = "";
        $this->ChartCatatanPesanPelapor->SeriesDateType = "";
        $this->ChartCatatanPesanPelapor->XAxisDateFormat = 7;
        $this->ChartCatatanPesanPelapor->ID = "ReportLogUserChat_ChartCatatanPesanPelapor"; // Chart ID
        $this->ChartCatatanPesanPelapor->setParameters([
            ["type", "1001"],
            ["seriestype", "0"]
        ]); // Chart type / Chart series type
        $this->ChartCatatanPesanPelapor->setParameters([
            ["caption", $this->ChartCatatanPesanPelapor->caption()],
            ["xaxisname", $this->ChartCatatanPesanPelapor->xAxisName()]
        ]); // Chart caption / X axis name
        $this->ChartCatatanPesanPelapor->setParameter("yaxisname", $this->ChartCatatanPesanPelapor->yAxisName()); // Y axis name
        $this->ChartCatatanPesanPelapor->setParameters([
            ["shownames", "1"],
            ["showvalues", "1"],
            ["showhovercap", "1"]
        ]); // Show names / Show values / Show hover
        $this->ChartCatatanPesanPelapor->setParameter("alpha", "50"); // Chart alpha
        $this->ChartCatatanPesanPelapor->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette

        // Chart Catatan Pertanyaan
        $this->ChartCatatanPertanyaan = new DbChart($this, 'ChartCatatanPertanyaan', 'Chart Catatan Pertanyaan', 'pesan', 'pelapor_id', 1001, '', 0, 'COUNT', 600, 500);
        $this->ChartCatatanPertanyaan->YAxisFormat = ["Number"];
        $this->ChartCatatanPertanyaan->YFieldFormat = ["Number"];
        $this->ChartCatatanPertanyaan->SortType = 4;
        $this->ChartCatatanPertanyaan->SortSequence = "";
        $this->ChartCatatanPertanyaan->SqlSelect = $this->getQueryBuilder()->select("`pesan`", "''", "COUNT(`pelapor_id`)");
        $this->ChartCatatanPertanyaan->SqlGroupBy = "`pesan`";
        $this->ChartCatatanPertanyaan->SqlOrderBy = "";
        $this->ChartCatatanPertanyaan->SeriesDateType = "";
        $this->ChartCatatanPertanyaan->ID = "ReportLogUserChat_ChartCatatanPertanyaan"; // Chart ID
