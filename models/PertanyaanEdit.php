 ...
 * Page class
 */
class PertanyaanEdit extends Pertanyaan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PertanyaanEdit";
    ...
    protected function editRow()
    {
        ...
        // jawaban
        $this->jawaban->setDbValueDef($rsnew, $this->jawaban->CurrentValue, null, $this->jawaban->ReadOnly);
