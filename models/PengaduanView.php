 ...
 * Page class
 */
class PengaduanView extends Pengaduan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengaduanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PengaduanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PengaduanList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PengaduanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
