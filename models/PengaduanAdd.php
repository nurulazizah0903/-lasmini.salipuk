 ...
 * Page class
 */
class PengaduanAdd extends Pengaduan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengaduanAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PengaduanView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // kordinat
        $this->kordinat->setDbValueDef($rsnew, $this->kordinat->CurrentValue, null, false);
        ...
        // waktu
        $this->waktu->setDbValueDef($rsnew, UnFormatDateTime($this->waktu->CurrentValue, $this->waktu->formatPattern()), null, false);
