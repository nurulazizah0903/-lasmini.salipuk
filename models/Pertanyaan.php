...
/**
 * Table class for pertanyaan
 */
class Pertanyaan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pertanyaan';
        $this->TableName = 'pertanyaan';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`pertanyaan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->pid->Lookup = new Lookup('pid', 'pertanyaan', false, 'id', ["code","","",""], [], [], [], [], [], [], '', '', "`code`");
        ...
        $this->jawaban->InputTextType = "text";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pertanyaan`";
    }
    ...
    public function getSqlSelectList() // Select for List page
    {
        ...
        $from = "(SELECT *, (SELECT `code` FROM `pertanyaan` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`id` = `pertanyaan`.`pid` LIMIT 1) AS `EV__pid` FROM `pertanyaan`)";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PertanyaanList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PertanyaanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PertanyaanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PertanyaanView";
            case Config("API_ADD_ACTION"):
                return "PertanyaanAdd";
            case Config("API_EDIT_ACTION"):
                return "PertanyaanEdit";
            case Config("API_DELETE_ACTION"):
                return "PertanyaanDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PertanyaanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PertanyaanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PertanyaanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PertanyaanAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PertanyaanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PertanyaanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PertanyaanDelete", $this->getUrlParm());
    }
