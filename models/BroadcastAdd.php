...
class BroadcastAdd extends Broadcast
{
    ...
    protected function validateForm()
    {
        ...
        if (in_array("broadcast_tujuan", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("BroadcastTujuanGrid");
            if (in_array("broadcast_tujuan", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->broadcast_id->setSessionValue($this->id->CurrentValue); // Set master key
                $Security->loadCurrentUserLevel($this->ProjectID . "broadcast_tujuan"); // Load user level of detail table
                $addRow = $detailPage->gridInsert();
                $Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
                if (!$addRow) {
                $detailPage->broadcast_id->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
