 ...
 * Page class
 */
class PengaduanDelete extends Pengaduan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengaduanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PengaduanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PengaduanList"); // Return to list
                return;
            }
        }
