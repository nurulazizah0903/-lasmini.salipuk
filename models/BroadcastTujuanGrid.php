 ...
 * Page class
 */
class BroadcastTujuanGrid extends BroadcastTujuan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BroadcastTujuanGrid";
    ...
    public $FormName = "fbroadcast_tujuangrid";
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_pelapor_id") && $CurrentForm->hasValue("o_pelapor_id") && $this->pelapor_id->CurrentValue != $this->pelapor_id->DefaultValue) {
            return false;
        }
        return true;
    }
    ...
    {
        $this->pelapor_id->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_pelapor_id")) {
            $this->pelapor_id->setOldValue($CurrentForm->getValue("o_pelapor_id"));
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "broadcast") {
            $this->broadcast_id->CurrentValue = $this->broadcast_id->getSessionValue();
        }
        ...
        if ($this->broadcast_id->getSessionValue() != "") {
            $rsnew['broadcast_id'] = $this->broadcast_id->getSessionValue();
        }
