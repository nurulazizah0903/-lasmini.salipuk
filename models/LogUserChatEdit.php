 ...
 * Page class
 */
class LogUserChatEdit extends LogUserChat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LogUserChatEdit";
    ...
    protected function editRow()
    {
        ...
        // tanggal
        $this->tanggal->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal->CurrentValue, $this->tanggal->formatPattern()), null, $this->tanggal->ReadOnly);
