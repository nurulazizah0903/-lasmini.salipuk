 ...
 * Page class
 */
class PertanyaanDelete extends Pertanyaan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PertanyaanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PertanyaanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PertanyaanList"); // Return to list
                return;
            }
        }
