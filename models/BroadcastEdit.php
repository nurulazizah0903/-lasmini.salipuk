...
class BroadcastEdit extends Broadcast
{
    ...
    protected function validateForm()
    {
        ...
        if (in_array("broadcast_tujuan", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            if ($editRow) {
                $detailPage = Container("BroadcastTujuanGrid");
                if (in_array("broadcast_tujuan", $detailTblVar) && $detailPage->DetailEdit) {
                    $Security->loadCurrentUserLevel($this->ProjectID . "broadcast_tujuan"); // Load user level of detail table
