...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'gyTmsIS6zyXdZO8q', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/pubinamarga.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-teal",
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-teal navbar-dark border-bottom-0",
    ...
    "ADMIN_USER_NAME" => "disdukcapil-chatbot", // Administrator user name
    "ADMIN_PASSWORD" => "disdukcapil-chatbot", // Administrator password
